						...
						<div id="grid-wrapper">
							<div class="grid-item">
								...
								<div class="grid-content">
									<!-- 이름 & 국기-->
									<div id="wrapper-name">
										<a href="<%=odto_asia.getOnline_link()%>" target="_blank" id="onlineLink_asia<%=i%>"> <%=bdto_asia.getBrand_name()%> <span id="link-icon"> <i class="fas fa-external-link-alt"></i> </span> </a>
									...
									<div id="wrapper-check">
										...
										<span id="wrapper-content">
											...
											<%if(odto_asia.getOnline_method().contains("드로우") && user.equals("")){%>
												<span id="draw-status_asia<%=i%>"> <input id="drawCheckbox_asia<%=i%>" type="checkbox" style="width:18px; height:18px; vertical-align: middle;"> </span>
											<!-- 온라인 방식이 '드로우'이고 로그인이 되어있으면 -->
								...
								<div class="grid-time">
									<div id="remain-time">	
										...
										<span id="remain_time_status_asia<%=i%>">
											...
											<%}else if(odto_asia.getOnline_start_time().isEmpty() && odto_asia.getOnline_end_time().isEmpty()) {%>
												<span id="final_count_Online_start_time_asia<%=i%>" style="display:none;"> </span>
												<span id="final_count_Online_end_time_asia<%=i%>" style="display:none;"> </span>
												<span class="draw_count_result" id="draw_count_result_yet"> 미정 </span>
											<!-- 오늘이 시작시간 전이고 시작시간과 끝나는 시간이 모두 존재할때-->
						...
						<div id="grid-wrapper">
							<div class="grid-item">
								...
								<div class="grid-content">
									<!-- 이름 & 국기-->
									<div id="wrapper-name">
										<a href="<%=odto_america.getOnline_link()%>" target="_blank" id="onlineLink_america<%=i%>"> <%=bdto_america.getBrand_name()%> <span id="link-icon"> <i class="fas fa-external-link-alt"></i> </span> </a>
									...
									<div id="wrapper-check">
										...
										<span id="wrapper-content">
											...
											<%if(odto_america.getOnline_method().contains("드로우") && user.equals("")){%>
												<span id="draw-status_america<%=i%>"> <input id="drawCheckbox_america<%=i%>" type="checkbox" style="width:18px; height:18px; vertical-align: middle;"> </span>
											<!-- 온라인 방식이 '드로우'이고 로그인이 되어있으면 -->
								...
								<div class="grid-time">
									<div id="remain-time">	
										...
										<span id="remain_time_status_america<%=i%>">
											...
											<%}else if(odto_america.getOnline_start_time().isEmpty() && odto_america.getOnline_end_time().isEmpty()) {%>
												<span id="final_count_Online_start_time_america<%=i%>" style="display:none;"> </span>
												<span id="final_count_Online_end_time_america<%=i%>" style="display:none;"> </span>
												<span class="draw_count_result" id="draw_count_result_yet"> 미정 </span>
											<!-- 오늘이 시작시간 전이고 시작시간과 끝나는 시간이 모두 존재할때-->
						...
						<div id="grid-wrapper">
							<div class="grid-item">
								...
								<div class="grid-content">
									<!-- 이름 & 국기-->
									<div id="wrapper-name">
										<a href="<%=odto_europe.getOnline_link()%>" target="_blank" id="onlineLink_europe<%=i%>"> <%=bdto_europe.getBrand_name()%> <span id="link-icon"> <i class="fas fa-external-link-alt"></i> </span> </a>
									...
									<div id="wrapper-check">
										...
										<span id="wrapper-content">
											...
											<%if(odto_europe.getOnline_method().contains("드로우") && user.equals("")){%>
												<span id="draw-status_europe<%=i%>"> <input id="drawCheckbox_europe<%=i%>" type="checkbox" style="width:18px; height:18px; vertical-align: middle;"> </span>
											<!-- 온라인 방식이 '드로우'이고 로그인이 되어있으면 -->
								...
								<div class="grid-time">
									<div id="remain-time">	
										...
										<span id="remain_time_status_europe<%=i%>">
											...
											<%}else if(odto_europe.getOnline_start_time().isEmpty() && odto_europe.getOnline_end_time().isEmpty()) {%>
												<span id="final_count_Online_start_time_europe<%=i%>" style="display:none;"> </span>
												<span id="final_count_Online_end_time_europe<%=i%>" style="display:none;"> </span>
												<span class="draw_count_result" id="draw_count_result_yet"> 미정 </span>
											<!-- 오늘이 시작시간 전이고 시작시간과 끝나는 시간이 모두 존재할때-->
						...
						<div id="grid-wrapper">
							<div class="grid-item">
								...
								<div class="grid-content">
									<!-- 이름 & 국기-->
									<div id="wrapper-name">
										<a href="<%=odto_etc.getOnline_link()%>" target="_blank" id="onlineLink_etc<%=i%>"> <%=bdto_etc.getBrand_name()%> <span id="link-icon"> <i class="fas fa-external-link-alt"></i> </span> </a>
									...
									<div id="wrapper-check">
										...
										<span id="wrapper-content">
											...
											<%if(odto_etc.getOnline_method().contains("드로우") && user.equals("")){%>
												<span id="draw-status_etc<%=i%>"> <input id="drawCheckbox_etc<%=i%>" type="checkbox" style="width:18px; height:18px; vertical-align: middle;"> </span>
											<!-- 온라인 방식이 '드로우'이고 로그인이 되어있으면 -->
								...
								<div class="grid-time">
									<div id="remain-time">	
										...
										<span id="remain_time_status_etc<%=i%>">
											...
											<%}else if(odto_etc.getOnline_start_time().isEmpty() && odto_etc.getOnline_end_time().isEmpty()) {%>
												<span id="final_count_Online_start_time_etc<%=i%>" style="display:none;"> </span>
												<span id="final_count_Online_end_time_etc<%=i%>" style="display:none;"> </span>
												<span class="draw_count_result" id="draw_count_result_yet"> 미정 </span>
											<!-- 오늘이 시작시간 전이고 시작시간과 끝나는 시간이 모두 존재할때-->
