...
<meta name="description" content="최근 발매가 종료된 제품들" />

<meta property="og:type" content="website">
<meta property="og:description" content="최근 발매가 종료된 제품들">
<meta property="og:url" content="https://www.shoeinfo.co.kr">

<meta content="width=device-width, initial-scale=1" name="viewport" />
<link rel="icon" type="image/png" href="./icon/favicon-48x48.png" />
<title>발매완료 | SHOE INFO.</title>
...
<body oncontextmenu='return false' onselectstart='return false' ondragstart='return false'>	
	...
	<div id="wrapper" class="container">
		...
		<!-- 발매 완료 리스트 -->
		<div class="released-container" style="margin-top:40px; padding-top:0 !important;">
			<div class="sub-title">	
								...
								<a href="./SneakerDetail.go?model_stylecode=<%=released_sdto.getModel_stylecode()%>&num=<%=released_sdto.getNum()%>">
									...
									<div class="mainSneakerShoeInfo-container">
										...
										<div class="mainSneakerShoeInfo-name">
											<span> <%=released_sdto.getModel_name_kr()%> </span>
										</div>
									</div>
								</a>
							</div>		
